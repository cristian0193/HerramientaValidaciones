...
public class Grafica_Programadas_Ejecutadas extends javax.swing.JFrame {
    ...
    public int contador_ejecutadas(int semana, Object anos) {
        ...
        query = "SELECT COUNT(ESTADO_PROYECTO) AS EJECUTADAS "
    ...
    public static void main(String args[]) {
        new Grafica_Programadas_Ejecutadas().setVisible(true);
    }
}
